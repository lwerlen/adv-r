...
<details><summaryShow...</summary>

Results

```r
# R code chunks can be in here too
x <- cos(1 + 2)
```
...
<img src="diagrams/environments/bindings.png" title="plot of chunk unnamed-chunk-3" alt="plot of chunk unnamed-chunk-3" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/loop.png" title="plot of chunk unnamed-chunk-5" alt="plot of chunk unnamed-chunk-5" style="display: block; margin: auto;" />
...
```
<img src="diagrams/environments/parents.png" title="plot of chunk unnamed-chunk-11" alt="plot of chunk unnamed-chunk-11" style="display: block; margin: auto;" />
...
```
<img src="diagrams/environments/parents-empty.png" title="plot of chunk unnamed-chunk-14" alt="plot of chunk unnamed-chunk-14" style="display: block; margin: auto;" />
...
```r
env_parents(e2b)
#> [[1]]   <env: 0x55a75744b6d8>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0x55a759bf1bf8>
#> [[2]] $ <env: empty>
```
...
1.  Create an environment as illustrated by this picture.
    ...
    <img src="diagrams/environments/recursive-1.png" title="plot of chunk unnamed-chunk-28" alt="plot of chunk unnamed-chunk-28" style="display: block; margin: auto;" />

1.  Create a pair of environments as illustrated by this picture.

    <img src="diagrams/environments/recursive-2.png" title="plot of chunk unnamed-chunk-29" alt="plot of chunk unnamed-chunk-29" style="display: block; margin: auto;" />
...
```
<img src="diagrams/environments/where-ex.png" title="plot of chunk unnamed-chunk-34" alt="plot of chunk unnamed-chunk-34" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/search-path.png" title="plot of chunk unnamed-chunk-37" alt="plot of chunk unnamed-chunk-37" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/search-path-2.png" title="plot of chunk unnamed-chunk-39" alt="plot of chunk unnamed-chunk-39" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/binding.png" title="plot of chunk unnamed-chunk-41" alt="plot of chunk unnamed-chunk-41" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/binding-2.png" title="plot of chunk unnamed-chunk-43" alt="plot of chunk unnamed-chunk-43" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/namespace-bind.png" title="plot of chunk unnamed-chunk-45" alt="plot of chunk unnamed-chunk-45" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/namespace-env.png" title="plot of chunk unnamed-chunk-46" alt="plot of chunk unnamed-chunk-46" style="display: block; margin: auto;" />

Putting all these diagrams together we get:

<img src="diagrams/environments/namespace.png" title="plot of chunk unnamed-chunk-47" alt="plot of chunk unnamed-chunk-47" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/execution.png" title="The execution environment of a simple function call. Note that the parent of the execution environment is the function environment." alt="The execution environment of a simple function call. Note that the parent of the execution environment is the function environment." style="display: block; margin: auto;" />
...
plus_one
#> function(y) x + y
#> <environment: 0x55a759fa5a78>
```

<img src="diagrams/environments/closure.png" title="plot of chunk unnamed-chunk-53" alt="plot of chunk unnamed-chunk-53" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/closure-call.png" title="plot of chunk unnamed-chunk-55" alt="plot of chunk unnamed-chunk-55" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/calling.png" title="The graphical depiction of a simple call stack" alt="The graphical depiction of a simple call stack" style="display: block; margin: auto;" />
